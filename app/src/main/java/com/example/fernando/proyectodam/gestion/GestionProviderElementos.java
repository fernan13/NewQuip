...
public class GestionProviderElementos extends ContentProvider {
    ...
    public static final Uri ELEMENTOS_LOCALIZACION  = Uri.parse("content://" + AUTORIDAD + "/" + ContratoBaseDatos.Elementos.TABLA +
                                                                "/" + ContratoBaseDatos.Elementos.LOCALIZACION);
    ...
    private static final int ELEMENTOS_LOCALIZACION_TODO    = 6;

    private static final int ELEMENTOS_ID_MATCHER           = 7;
    private static final int ELEMENTOS_EL_MATCHER           = 8;
    private static final int MEDIA_MATCHER                  = 9;
    private static final int MEDIA_ID_MATCHER               = 10;
    private static final int ELEMENTOS_MEDIA_MATCHER        = 11;
    private static final int ELEMENTOS_MEDIA_ID_MATCHER     = 12;

    private static final int ELEMENTOS_UPDATE_SERVER        = 13;
    ...
    static {
        ...
        uriMatcher.addURI(  AUTORIDAD, ContratoBaseDatos.Elementos.TABLA + "/" + ContratoBaseDatos.Elementos.LOCALIZACION,
                            ELEMENTOS_LOCALIZACION_TODO);
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch( uriMatcher.match(uri) ) {
            ...
            case ELEMENTOS_LOCALIZACION_TODO: {

                selection       = ContratoBaseDatos.Elementos.TABLA + "." +
                                  ContratoBaseDatos.Elementos.LOCALIZACION + " != ? AND " +
                                  ContratoBaseDatos.Elementos.TABLA + "." +
                                  ContratoBaseDatos.Elementos.IDCORREO + " = ?";

                selectionArgs   = new String[]{"", idcorreo};

                System.out.println("Elementos localizacion OK");
