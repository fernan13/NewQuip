...
public class UtilFicheros {
    ...
    //Metodo utilizado para los procesos en segundo plano que no necesitan un hilo para acceder a las sp
    public static String getValueForSharedPreferences ( Context c, String name, String atributo ) {
