...
public class UtilWeb {
    ...
    public static final String URL_NOTA_HELP            = SERVER + "help/nota.php";
    public static final String URL_LISTA_HELP           = SERVER + "help/lista.php";
    public static final String URL_SHARE_HELP           = SERVER + "help/compartir.php";
    public static final String URL_SUG_HELP             = SERVER + "help/sugerencias.php";
    ...
    private static String getJsonFromObject( Context c, Object o ) {
        ...
        if ( o != null ) {
            ...
            if ( o instanceof Nota ) {
                ...
                items.put("localizacion", nota.getMap_not());
            }
            else
            {
                //Nos llega una lista
                if ( o instanceof Lista ) {
                    ...
                    items.put("localizacion", lista.getMap_not());
                }
                else
                {
                        ...
                        if ( response.contains("actualizar") ) {
                            ...
                            for (int i = 0; i < up.length(); i++) {
                                ...
                                if ( type == 0 ) {
                                    ...
                                    if ( !nota.getMap_not().isEmpty() ) mapNotification = true;
                                }
                                else
                                {
                                    ...
                                    if ( !lista.getMap_not().isEmpty() ) mapNotification = true;
                                }
                                ...
                                //Si existe notificaciones inicializamos el servicio
                                if ( mapNotification ) {
