...
public class Lista extends BaseObservable implements Parcelable {
    ...
    private int papelera,tipo, actualizar, correo, idserver, color;
    ...
    public Lista() {
        ...
        this( 0, "", new ArrayList<ElementoLista>(), 0, 1, 0, 0, 0, Color.parseColor("#FFFFFF"), "");
    }

    public Lista ( long id, String titulo, ArrayList<ElementoLista> items, int papelera, int tipo,
                   int actualizar, int correo, int idserver, int color, String fecha_not ) {
    ...
    public Lista ( long id, String titulo, String json, int papelera, int tipo , int actualizar,
                   int correo, int idserver, int color, String fecha_not ) {
    ...
    public static Lista getLista(Cursor c ) {
        ...
        return new Lista( id, titulo, json, papelera, tipo, actualizar, correo, idserver, color, fecha );
    }
