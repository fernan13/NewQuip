...
public class DialogoBorrarNota extends DialogFragment {
    private Nota n;

    // Interfaz de comunicación
    OnBorrarDialogListener listener;

    public DialogoBorrarNota() {
    }

    public static DialogoBorrarNota newInstance(Nota n) {
        DialogoBorrarNota fragment = new DialogoBorrarNota();
    ...
    public AlertDialog createDialogBorrar() {
        ...
        builder.setMessage(R.string.mensaje_confirm_borrar_nota);
