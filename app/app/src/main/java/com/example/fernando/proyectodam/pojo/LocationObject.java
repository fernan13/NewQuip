...
public class LocationObject {
    ...
    @DatabaseField(columnName =  ContratoBaseDatos.LocationObject.FIELD_NAME_ID_ELEM)
    private long idE;

    public LocationObject(){}


    public LocationObject ( double latitud, double longitud, String fecha, int email, String titulo, long idE ) {
