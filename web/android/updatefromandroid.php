        ...
        if ( $tipo_el == 0 ) {
            ...
            if ( $id != 0 ) {
                ...
                $query = "update elementos set Titulo = '$titulo', Contenido = '$cuerpo', 
                          ...
                          Orden = $orden, Localizacion = '$loc' where _ID = $id and Email = '$correo'";
            ...
            else
            {
                ...
                $query = "insert into elementos (Titulo, Contenido, Tipo, Papelera, 
                         Notificacion, Email, Color, Localizacion ) values ( '$titulo', '$cuerpo', $tipo_el, $papelera, 
                         '$fec_not', $correo, $color, '$loc' )";
