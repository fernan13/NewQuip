    ...
    if ( !empty($accion) || count($accion) > 0 ) {
        ...
        if ( $accion == "actualizar") 
        {
            ...
            $query_update   =   "select elementos._id, elementos.Titulo, elementos.Contenido, elementos.Tipo, 
                                elementos.Papelera, elementos.Notificacion, elementos.Color, elementos.Orden, media.BlobType 
                                from elementos left join media on elementos._ID = media.ParentId 
                                inner join actualizar on elementos._ID = actualizar.idElemento 
